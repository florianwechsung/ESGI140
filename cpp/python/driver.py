...
tstarts = [0] * (n//3) + [600] * (n//3) + [1200] * (n-n//3-n//3)
...
wasted_time = e.calculate_average_wasted_time(res_x, vmaxs, res_t, 5000);
print("Average wasted time per runner: ", wasted_time)
import sys
sys.exit(1)
